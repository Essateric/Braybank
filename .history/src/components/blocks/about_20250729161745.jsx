...
function AboutSection() {
  return (
    <section id="about" className="relative py-20 bg-white overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto mb-12 bg-[#222] rounded-xl shadow-lg px-7 py-6 text-[#f7c873]">
        ...
        <p className="text-sm mb-2 text-[#f7c873]">
      ...
      {/* News Card - Matching Style */}
      <div className="bg-white border border-blue-100 shadow-md py-6 px-7 rounded-xl max-w-2xl mx-auto mt-16 mb-8">
        <p className="text-base font-semibold mb-2 text-blue-700">
          <a
        ...
        <p className="text-[15px] text-gray-700 leading-relaxed">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            the laying of the resin footpaths
          </a>{' '}
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            seasonal images in and around Braybank
          </a>
          .
        </p>
      </div>
