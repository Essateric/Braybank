...
export default function ContactSection() {
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white relative px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
        ...
        <div className="flex justify-center">
          <div className="grid lg:grid-cols-2 gap-16 w-full max-w-6xl">
            ...
            {/* Contact Form */}
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-3xl border border-white/20 w-full max-w-xl mx-auto">
