...
<div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-10">
  {features.map((item, index) => (
    <div key={index} className="group">
      <div className="bg-black/10 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-white/20 backdrop-blur-md text-center">
        <div
        ...
        <p className="text-black/90 leading-relaxed font-light">
          {item.description}
        </p>
      </div>
    </div>
