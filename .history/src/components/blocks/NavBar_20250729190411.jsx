...
function Navbar() {
  ...
  // Keep dropdown open while hovering on item or dropdown itself
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-4">
        ...
        <div className="flex-1 flex justify-center">
          <ul className="flex gap-6 font-medium text-lg">
            ...
            >
              ...
              {openDropdown === "about" && (
                ...
                >
                  <a
                    href="#about"
                    className="block px-4 py-2 text-black hover:bg-blue-50"
                  >
                    About the Estate
                  </a>
                  <a
            ...
            <li
              className="relative"
              onMouseEnter={() => handleDropdownEnter("bel")}
              onMouseLeave={handleDropdownLeave}
            >
              <a
                href="/shareholders"
                ...
                onClick={e => {
                  // Only open dropdown, don't follow link
                  e.preventDefault();
                  setOpenDropdown(openDropdown === "bel" ? null : "bel");
                }}
              >
                BEL Shareholders
              </a>
              {openDropdown === "bel" && (
                <div className="absolute left-0 mt-2 w-56 bg-white shadow-lg rounded border border-slate-200 z-30"
                  onMouseEnter={() => handleDropdownEnter("bel")}
                  onMouseLeave={handleDropdownLeave}
                >
                  <a
